...
SAMPLE_DOCS = [
    (
        "sample_data/clinical_guidelines.txt",
        "Clinical Practice Guidelines — Hypertension 2024",
        "clinical_guideline",
    ),
    (
        "sample_data/medication_interactions.txt",
        "Common Drug Interactions Reference",
        "medication_db",
    ),
    (
        "sample_data/medical_glossary.txt",
        "Medical Terminology Glossary",
        "medical_glossary",
    ),
    (
        "sample_data/hl7_fhir_reference.txt",
        "HL7 FHIR R4 Quick Reference",
        "hl7_standard",
    ),
    (
        "sample_data/diabetes_management.txt",
        "Diabetes Management Protocol — ADA 2024",
        "clinical_guideline",
    ),
]
